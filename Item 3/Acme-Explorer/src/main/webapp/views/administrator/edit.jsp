...
<display:table pagesize="3" class="displaytag" keepStatus="true"
	name="socialIdentities" requestURI="actor/admin/admin/edit.do" id="row">
	...
	<security:authorize access="isAuthenticated()">
		<display:column>
			<a href="socialIdentity/edit.do?socialIdentityId=${row.id}"> <spring:message
					code="administrator.socialIdentity.editar" />
			</a>
		</display:column>
	</security:authorize>
...
<security:authorize access="isAuthenticated()">
	<div>
		<a href="socialIdentity/create.do"> <spring:message
				code="administrator.socialIdentity.create" />
		</a>
	</div>
</security:authorize>
