...
<form:form action="actor/auditor/edit.do" id="formID"
...
<display:table pagesize="3" class="displaytag" keepStatus="true"
	name="socialIdentities" requestURI="actor/admin/auditor/edit.do" id="row">
	...
	<security:authorize access="isAuthenticated()">
		<display:column>
			<a href="socialIdentity/edit.do?socialIdentityId=${row.id}"> <spring:message
					code="auditor.socialIdentity.editar" />
			</a>
		</display:column>
	</security:authorize>
...
<security:authorize access="isAuthenticated()">
	<div>
		<a href="socialIdentity/create.do"> <spring:message
				code="auditor.socialIdentity.create" />
		</a>
	</div>
</security:authorize>
