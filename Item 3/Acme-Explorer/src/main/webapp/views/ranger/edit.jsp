...
<form:form action="actor/ranger/edit.do" id="formID" modelAttribute="ranger">
	...
	<input type="submit" name="save"
		value="<spring:message code="ranger.edit" />" />
...
<display:table pagesize="3" class="displaytag" keepStatus="true"
	name="socialIdentities" requestURI="actor/admin/ranger/edit.do"
	id="row">
	...
	<security:authorize access="isAuthenticated()">
		<display:column>
			<a href="socialIdentity/edit.do?socialIdentityId=${row.id}"> <spring:message
					code="ranger.socialIdentity.editar" />
			</a>
		</display:column>
	</security:authorize>
...
<security:authorize access="isAuthenticated()">
	<div>
		<a href="socialIdentity/create.do"> <spring:message
				code="ranger.socialIdentity.create" />
		</a>
	</div>
</security:authorize>
